...
if (!scriptMatch || !styleMatch) throw new Error('Could not locate built app assets for the offline shell')
...
await copyFile(new URL('../staticwebapp.config.json', import.meta.url), join(rootPath, 'staticwebapp.config.json'))
